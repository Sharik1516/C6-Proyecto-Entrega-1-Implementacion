...
public class UsuarioController {
    ...
    public String usuarioGuardar(@ModelAttribute Usuario usuario) {
        usuarioRepository.insertarUsuario(usuario.getTipoDocumento(), usuario.getNumeroDocumento(), usuario.getNombre());
    ...
    public String usuarioEditarGuardar(@PathVariable("id") int id, @ModelAttribute Usuario usuario) {
        usuarioRepository.actualizarUsuario(id, usuario.getTipoDocumento(), usuario.getNumeroDocumento(), usuario.getNombre());
        return "redirect:/usuarios";
    }
